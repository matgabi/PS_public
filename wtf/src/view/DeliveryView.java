...
public class DeliveryView extends BorderPane {
    ...
    @FXML
    TextField availableInvoicesText;
    ...
    private void initialize()
    {
        ...
        availableInvoicesText.setText(new Integer(deliveryController.getInvoicesAvailable()).toString());
    ...
    @FXML
    private void buyMoreInvoices()
    {
        deliveryController.buyMoreInvoices();
        availableInvoicesText.setText(new Integer(deliveryController.getInvoicesAvailable()).toString());
